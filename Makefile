...
export NOTEBOOK_VERSION = $(NOTEBOOK_IMAGE):v6.4.0
export NOTEBOOK_LATEST = $(NOTEBOOK_IMAGE):latest

#
# The base version from which most other images are built
#
export NOTEBOOK_COMMON_BASE=v6.4.0
export NOTEBOOK_COMMON_BASE_AI=v6.4.0
export NOTEBOOK_COMMON_BASE_PL=v6.4.0

export NOTEBOOK_PL_IMAGE = $(DOCKER_REPO)/notebook-pl$(DEV_LABEL)
export NOTEBOOK_PL_VERSION = $(NOTEBOOK_PL_IMAGE):v6.4.0
