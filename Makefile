...
export NOTEBOOK_COMMON_BASE_PL=v6.5.2.2
...
export NOTEBOOK_DB_VERSION = $(NOTEBOOK_DB_IMAGE):$(DB_VERSION_NUMBER)
...
export NOTEBOOK_QT_VERSION = $(NOTEBOOK_QT_IMAGE):$(QT_VERSION_NUMBER)
...
export NOTEBOOK_INTROC_VERSION = $(NOTEBOOK_INTROC_IMAGE):$(INTROC_VERSION_NUMBER)
...
export NOTEBOOK_CC_VERSION = $(NOTEBOOK_CC_IMAGE):$(CC_VERSION_NUMBER)
...
export NOTEBOOK_DSA_IMAGE = $(DOCKER_REPO)/notebook-dsa$(DEV_LABEL)
...
push-appliedml: build-appliedml
	-docker push $(NOTEBOOK_APPLIEDML_VERSION)
	-docker push $(NOTEBOOK_APPLIEDML_LATEST)
